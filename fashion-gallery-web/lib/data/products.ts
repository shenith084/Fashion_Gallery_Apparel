...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 4790,
    image: '/prod-wrap-midi.png', // Using existing mock images
    images: ['/prod-wrap-midi.png'],
    category: 'Office Wear',
    categorySlug: 'office-wear',
    rating: 4.5,
    reviewCount: 63,
