...
export const metadata = { title: 'Best Sellers | Fashion Gallery Apparel' };
    ...
    <>
      ...
      <div style={{ background: 'var(--color-soft-beige)', padding: 'var(--space-12) 0 var(--space-8)', textAlign: 'center', borderBottom: '1px solid rgba(107, 35, 53, 0.08)' }}>
        <div className="container">
          <h1 style={{ fontFamily: 'var(--font-heading)', fontSize: '2.5rem', color: 'var(--color-charcoal)' }}>Best Sellers</h1>
        </div>
      </div>
      <div className="container">
        <ShopClient initialCategory="best-sellers" />
      </div>
      <Footer />
    </>
  );
